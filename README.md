...
- **Smart Academic Dashboard** — prioritises upcoming classes, deadlines, exams and next actions.
- **Timetable Integration** — manage imported and manual classes in one timetable.
- **Timetable Change Notifications** — receive alerts for added classes, cancellations and room/location changes.
- **Deadlines & Exams** — track due dates, assessment weighting, progress and reminders.
- **Grades & Modules** — organise modules and track academic results throughout the semester.
- **Groups & Shared Deadlines** — collaborate with other students on shared coursework deadlines.
...
Semestio is designed for desktop, tablet and mobile use, with an installable Progressive Web App experience on supported devices.

## 🚀 Project Status

Semestio is actively developed and deployed at **https://semestio.com**.
